 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, SymExprHint& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_int")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("as_int"));
      nlohmann_json_t.tag_ = Tag::AS_INT;
      return;
    }        
    if (nlohmann_json_j.contains("as_float")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("as_float"));
      nlohmann_json_t.tag_ = Tag::AS_FLOAT;
      return;
    }        
    if (nlohmann_json_j.contains("as_bool")) {
      nlohmann_json_t.variant_.emplace<3>(nlohmann_json_j.at("as_bool"));
...
class SymExpr {
 ...
 public:
  ...
  SymExpr& operator=(const SymExpr&) = default;
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, SymInt& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_expr")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("as_expr"));
      nlohmann_json_t.tag_ = Tag::AS_EXPR;
      return;
    }        
    if (nlohmann_json_j.contains("as_int")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("as_int"));
      nlohmann_json_t.tag_ = Tag::AS_INT;
      return;
    }
  }
...
class SymBool {
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, SymBool& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_bool")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("as_bool"));
      nlohmann_json_t.tag_ = Tag::AS_BOOL;
      return;
    }
  }
...
class TensorMeta {
 ...
 public:
  ...
  TensorMeta& operator=(const TensorMeta&) = default;
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, SymIntArgument& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_name")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("as_name"));
...
class TensorArgument {
 ...
 public:
  ...
  TensorArgument& operator=(const TensorArgument&) = default;
...
class TokenArgument {
 ...
 public:
  ...
  TokenArgument& operator=(const TokenArgument&) = default;
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, OptionalTensorArgument& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_tensor")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("as_tensor"));
      nlohmann_json_t.tag_ = Tag::AS_TENSOR;
      return;
    }        
    if (nlohmann_json_j.contains("as_none")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("as_none"));
...
class GraphArgument {
 ...
 public:
  ...
  GraphArgument& operator=(const GraphArgument&) = default;
...
class CustomObjArgument {
 ...
 public:
  ...
  CustomObjArgument& operator=(const CustomObjArgument&) = default;
...
class Argument {
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, Argument& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_none")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("as_none"));
      nlohmann_json_t.tag_ = Tag::AS_NONE;
      return;
    }        
    if (nlohmann_json_j.contains("as_tensor")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("as_tensor"));
      nlohmann_json_t.tag_ = Tag::AS_TENSOR;
      return;
    }        
    if (nlohmann_json_j.contains("as_tensors")) {
      nlohmann_json_t.variant_.emplace<3>(nlohmann_json_j.at("as_tensors"));
      nlohmann_json_t.tag_ = Tag::AS_TENSORS;
      return;
    }        
    if (nlohmann_json_j.contains("as_int")) {
      nlohmann_json_t.variant_.emplace<4>(nlohmann_json_j.at("as_int"));
      nlohmann_json_t.tag_ = Tag::AS_INT;
      return;
    }        
    if (nlohmann_json_j.contains("as_ints")) {
      nlohmann_json_t.variant_.emplace<5>(nlohmann_json_j.at("as_ints"));
      nlohmann_json_t.tag_ = Tag::AS_INTS;
      return;
    }        
    if (nlohmann_json_j.contains("as_float")) {
      nlohmann_json_t.variant_.emplace<6>(nlohmann_json_j.at("as_float"));
      nlohmann_json_t.tag_ = Tag::AS_FLOAT;
      return;
    }        
    if (nlohmann_json_j.contains("as_floats")) {
      nlohmann_json_t.variant_.emplace<7>(nlohmann_json_j.at("as_floats"));
      nlohmann_json_t.tag_ = Tag::AS_FLOATS;
      return;
    }        
    if (nlohmann_json_j.contains("as_string")) {
      nlohmann_json_t.variant_.emplace<8>(nlohmann_json_j.at("as_string"));
      nlohmann_json_t.tag_ = Tag::AS_STRING;
      return;
    }        
    if (nlohmann_json_j.contains("as_strings")) {
      nlohmann_json_t.variant_.emplace<9>(nlohmann_json_j.at("as_strings"));
      nlohmann_json_t.tag_ = Tag::AS_STRINGS;
      return;
    }        
    if (nlohmann_json_j.contains("as_sym_int")) {
      nlohmann_json_t.variant_.emplace<10>(nlohmann_json_j.at("as_sym_int"));
      nlohmann_json_t.tag_ = Tag::AS_SYM_INT;
      return;
    }        
    if (nlohmann_json_j.contains("as_sym_ints")) {
      nlohmann_json_t.variant_.emplace<11>(nlohmann_json_j.at("as_sym_ints"));
      nlohmann_json_t.tag_ = Tag::AS_SYM_INTS;
      return;
    }        
    if (nlohmann_json_j.contains("as_scalar_type")) {
      nlohmann_json_t.variant_.emplace<12>(nlohmann_json_j.at("as_scalar_type"));
      nlohmann_json_t.tag_ = Tag::AS_SCALAR_TYPE;
      return;
    }        
    if (nlohmann_json_j.contains("as_memory_format")) {
      nlohmann_json_t.variant_.emplace<13>(nlohmann_json_j.at("as_memory_format"));
      nlohmann_json_t.tag_ = Tag::AS_MEMORY_FORMAT;
      return;
    }        
    if (nlohmann_json_j.contains("as_layout")) {
      nlohmann_json_t.variant_.emplace<14>(nlohmann_json_j.at("as_layout"));
      nlohmann_json_t.tag_ = Tag::AS_LAYOUT;
      return;
    }        
    if (nlohmann_json_j.contains("as_device")) {
      nlohmann_json_t.variant_.emplace<15>(nlohmann_json_j.at("as_device"));
      nlohmann_json_t.tag_ = Tag::AS_DEVICE;
      return;
    }        
    if (nlohmann_json_j.contains("as_bool")) {
      nlohmann_json_t.variant_.emplace<16>(nlohmann_json_j.at("as_bool"));
      nlohmann_json_t.tag_ = Tag::AS_BOOL;
      return;
    }        
    if (nlohmann_json_j.contains("as_bools")) {
      nlohmann_json_t.variant_.emplace<17>(nlohmann_json_j.at("as_bools"));
      nlohmann_json_t.tag_ = Tag::AS_BOOLS;
      return;
    }        
    if (nlohmann_json_j.contains("as_sym_bool")) {
      nlohmann_json_t.variant_.emplace<18>(nlohmann_json_j.at("as_sym_bool"));
      nlohmann_json_t.tag_ = Tag::AS_SYM_BOOL;
      return;
    }        
    if (nlohmann_json_j.contains("as_sym_bools")) {
      nlohmann_json_t.variant_.emplace<19>(nlohmann_json_j.at("as_sym_bools"));
      nlohmann_json_t.tag_ = Tag::AS_SYM_BOOLS;
      return;
    }        
    if (nlohmann_json_j.contains("as_graph")) {
      nlohmann_json_t.variant_.emplace<20>(nlohmann_json_j.at("as_graph"));
      nlohmann_json_t.tag_ = Tag::AS_GRAPH;
      return;
    }        
    if (nlohmann_json_j.contains("as_optional_tensors")) {
      nlohmann_json_t.variant_.emplace<21>(nlohmann_json_j.at("as_optional_tensors"));
      nlohmann_json_t.tag_ = Tag::AS_OPTIONAL_TENSORS;
      return;
    }        
    if (nlohmann_json_j.contains("as_custom_obj")) {
      nlohmann_json_t.variant_.emplace<22>(nlohmann_json_j.at("as_custom_obj"));
      nlohmann_json_t.tag_ = Tag::AS_CUSTOM_OBJ;
      return;
    }        
    if (nlohmann_json_j.contains("as_operator")) {
      nlohmann_json_t.variant_.emplace<23>(nlohmann_json_j.at("as_operator"));
...
class NamedArgument {
 ...
 public:
  ...
  NamedArgument& operator=(const NamedArgument&) = default;
...
class UserInputSpec {
 ...
 public:
  ...
  UserInputSpec& operator=(const UserInputSpec&) = default;
...
class ConstantValue {
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, ConstantValue& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_float")) {
      nlohmann_json_t.variant_.emplace<3>(nlohmann_json_j.at("as_float"));
      nlohmann_json_t.tag_ = Tag::AS_FLOAT;
      return;
    }        
    if (nlohmann_json_j.contains("as_string")) {
      nlohmann_json_t.variant_.emplace<4>(nlohmann_json_j.at("as_string"));
      nlohmann_json_t.tag_ = Tag::AS_STRING;
      return;
    }        
    if (nlohmann_json_j.contains("as_bool")) {
      nlohmann_json_t.variant_.emplace<5>(nlohmann_json_j.at("as_bool"));
      nlohmann_json_t.tag_ = Tag::AS_BOOL;
      return;
    }
  }
...
class ConstantInputSpec {
 ...
 public:
  ...
  ConstantInputSpec& operator=(const ConstantInputSpec&) = default;
...
class InputToParameterSpec {
 ...
 public:
  ...
  InputToParameterSpec& operator=(const InputToParameterSpec&) = default;
...
class InputToBufferSpec {
 ...
 public:
  ...
  InputToBufferSpec& operator=(const InputToBufferSpec&) = default;
...
class InputToTensorConstantSpec {
 ...
 public:
  ...
  InputToTensorConstantSpec& operator=(const InputToTensorConstantSpec&) = default;
...
class InputToCustomObjSpec {
 ...
 public:
  ...
  InputToCustomObjSpec& operator=(const InputToCustomObjSpec&) = default;
...
class InputTokenSpec {
 ...
 public:
  ...
  InputTokenSpec& operator=(const InputTokenSpec&) = default;
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, InputSpec& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("user_input")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("user_input"));
      nlohmann_json_t.tag_ = Tag::USER_INPUT;
      return;
    }        
    if (nlohmann_json_j.contains("parameter")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("parameter"));
      nlohmann_json_t.tag_ = Tag::PARAMETER;
      return;
    }        
    if (nlohmann_json_j.contains("buffer")) {
      nlohmann_json_t.variant_.emplace<3>(nlohmann_json_j.at("buffer"));
      nlohmann_json_t.tag_ = Tag::BUFFER;
      return;
    }        
    if (nlohmann_json_j.contains("tensor_constant")) {
      nlohmann_json_t.variant_.emplace<4>(nlohmann_json_j.at("tensor_constant"));
      nlohmann_json_t.tag_ = Tag::TENSOR_CONSTANT;
      return;
    }        
    if (nlohmann_json_j.contains("custom_obj")) {
      nlohmann_json_t.variant_.emplace<5>(nlohmann_json_j.at("custom_obj"));
      nlohmann_json_t.tag_ = Tag::CUSTOM_OBJ;
      return;
    }        
    if (nlohmann_json_j.contains("token")) {
      nlohmann_json_t.variant_.emplace<6>(nlohmann_json_j.at("token"));
      nlohmann_json_t.tag_ = Tag::TOKEN;
      return;
    }        
    if (nlohmann_json_j.contains("constant_input")) {
      nlohmann_json_t.variant_.emplace<7>(nlohmann_json_j.at("constant_input"));
...
class UserOutputSpec {
 ...
 public:
  ...
  UserOutputSpec& operator=(const UserOutputSpec&) = default;
...
class LossOutputSpec {
 ...
 public:
  ...
  LossOutputSpec& operator=(const LossOutputSpec&) = default;
...
class BufferMutationSpec {
 ...
 public:
  ...
  BufferMutationSpec& operator=(const BufferMutationSpec&) = default;
...
class GradientToParameterSpec {
 ...
 public:
  ...
  GradientToParameterSpec& operator=(const GradientToParameterSpec&) = default;
...
class GradientToUserInputSpec {
 ...
 public:
  ...
  GradientToUserInputSpec& operator=(const GradientToUserInputSpec&) = default;
...
class UserInputMutationSpec {
 ...
 public:
  ...
  UserInputMutationSpec& operator=(const UserInputMutationSpec&) = default;
...
class OutputTokenSpec {
 ...
 public:
  ...
  OutputTokenSpec& operator=(const OutputTokenSpec&) = default;
 ...
 public:
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, OutputSpec& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("user_output")) {
      nlohmann_json_t.variant_.emplace<1>(nlohmann_json_j.at("user_output"));
      nlohmann_json_t.tag_ = Tag::USER_OUTPUT;
      return;
    }        
    if (nlohmann_json_j.contains("loss_output")) {
      nlohmann_json_t.variant_.emplace<2>(nlohmann_json_j.at("loss_output"));
      nlohmann_json_t.tag_ = Tag::LOSS_OUTPUT;
      return;
    }        
    if (nlohmann_json_j.contains("buffer_mutation")) {
      nlohmann_json_t.variant_.emplace<3>(nlohmann_json_j.at("buffer_mutation"));
      nlohmann_json_t.tag_ = Tag::BUFFER_MUTATION;
      return;
    }        
    if (nlohmann_json_j.contains("gradient_to_parameter")) {
      nlohmann_json_t.variant_.emplace<4>(nlohmann_json_j.at("gradient_to_parameter"));
      nlohmann_json_t.tag_ = Tag::GRADIENT_TO_PARAMETER;
      return;
    }        
    if (nlohmann_json_j.contains("gradient_to_user_input")) {
      nlohmann_json_t.variant_.emplace<5>(nlohmann_json_j.at("gradient_to_user_input"));
      nlohmann_json_t.tag_ = Tag::GRADIENT_TO_USER_INPUT;
      return;
    }        
    if (nlohmann_json_j.contains("user_input_mutation")) {
      nlohmann_json_t.variant_.emplace<6>(nlohmann_json_j.at("user_input_mutation"));
      nlohmann_json_t.tag_ = Tag::USER_INPUT_MUTATION;
      return;
    }        
    if (nlohmann_json_j.contains("token")) {
      nlohmann_json_t.variant_.emplace<7>(nlohmann_json_j.at("token"));
      nlohmann_json_t.tag_ = Tag::TOKEN;
      return;
    }
  }
...
class GraphSignature {
 ...
 public:
  ...
  GraphSignature& operator=(const GraphSignature&) = default;
...
class RangeConstraint {
 ...
 public:
  ...
  RangeConstraint& operator=(const RangeConstraint&) = default;
...
class ModuleCallSignature {
 ...
 public:
  ...
  ModuleCallSignature& operator=(const ModuleCallSignature&) = default;
...
class ModuleCallEntry {
 ...
 public:
  ...
  ModuleCallEntry& operator=(const ModuleCallEntry&) = default;
...
class GraphModule {
 ...
 public:
  ...
  GraphModule& operator=(const GraphModule&) = default;
...
class SchemaVersion {
 ...
 public:
  ...
  SchemaVersion& operator=(const SchemaVersion&) = default;
...
class ExportedProgram {
 ...
 public:
  ...
  ExportedProgram& operator=(const ExportedProgram&) = default;
